...
A GitHub action to turn a GitHub project into a self-hosted Helm chart repo, using [nholuongut/chart-releaser](https://github.com/nholuongut/chart-releaser) CLI tool.
...
- `config`: Optional config file for chart-releaser. For more information on the config file, see the [documentation](https://github.com/nholuongut/chart-releaser#config-file)
...
For more information on environment variables, see the [documentation](https://github.com/nholuongut/chart-releaser#environment-variables).
...
This uses [@nholuongut/chart-releaser-action](https://github.com/nholuongut/chart-releaser-action) to turn your GitHub project into a self-hosted Helm chart repo.
...
For options see [config-file](https://github.com/nholuongut/chart-releaser#config-file).
